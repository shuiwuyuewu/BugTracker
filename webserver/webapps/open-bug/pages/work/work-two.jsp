...
<body>
	...
	<td class="btn-col" align="center">
		<div class="btn-group button-div">
			...
			<a href="#" onclick="return false;" class="btn disabled">双栏</a>
	...
	<script>
		...
		var col = 2, wspan = readStatus ? 20 : 12, pinfo = ${projects}, rinfo = ${records}, sortInfo = [], html = "", hasMore = "${hasMore}", statusStat = ${statusStat}, bugProjectChart = ${bugPjtStat};
