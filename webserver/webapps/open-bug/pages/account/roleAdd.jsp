	...
	<script>
		...
		function initResource() {
			_remoteCall("role/getResources.do", null, function(data) {
				$("#PJT").html(combineResHtml(data.PJT));
				$("#BUG").html(combineResHtml(data.BUG));
