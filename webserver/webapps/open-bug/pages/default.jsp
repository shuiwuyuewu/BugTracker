...
<body>
	...
	<div id="mainContent">
		<ul id="navtab">
			<li url="<c:url value="/work/openWork.do?readStatus=Y" />">工作面板</li>
			<li url="<c:url value="/pages/project/project.jsp" />">项目状态</li>
			<li url="<c:url value="/pages/bug/bug.jsp" />">缺陷列表</li>
			<li url="<c:url value="/share/openShare.do" />">经验分享</li>
