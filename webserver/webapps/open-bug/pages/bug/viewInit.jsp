	...
	<div class="wrapper">
		...
		<div id="btnDiv">
			...
			<div class="operate-div" style="display: none;">
				<a href="<c:url value="/bug/openOperate.do?op=edit&fromStatus=1&bugId=${param.bugId}" />" class="button button-rounded button-flat-primary">编辑</a>
				<a href="<c:url value="/bug/openOperate.do?op=commit&fromStatus=1&bugId=${param.bugId}" />" class="button button-rounded button-flat-primary">提交</a>
			</div>
		</div>
