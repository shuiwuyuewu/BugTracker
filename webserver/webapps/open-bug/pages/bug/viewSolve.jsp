	...
	<div class="wrapper">
		...
		<div id="btnDiv">
			...
			<div class="operate-div" style="display: none;">
				<a href="<c:url value="/bug/openOperate.do?op=gotest&fromStatus=3&bugId=${param.bugId}" />" class="button button-rounded button-flat-primary">提交测试</a>
				<a href="<c:url value="/bug/openOperate.do?op=assign&fromStatus=3&bugId=${param.bugId}" />" class="button button-rounded button-flat-primary">更换责任人</a>
				<a href="<c:url value="/bug/openOperate.do?op=hangup&fromStatus=3&bugId=${param.bugId}" />" class="button button-rounded button-flat-primary">挂起</a>
			</div>
		</div>
