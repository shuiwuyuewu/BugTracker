	...
	<div class="wrapper">
		...
		<div id="btnDiv">
			...
			<div class="operate-div" style="display: none;">
				<a href="<c:url value="/bug/openOperate.do?op=assign&fromStatus=2&bugId=${param.bugId}" />" class="button button-rounded button-flat-primary">指定修改</a>
				<a href="<c:url value="/bug/openOperate.do?op=unpass&fromStatus=2&bugId=${param.bugId}" />" class="button button-rounded button-flat-primary">审核不通过</a>
				<a href="<c:url value="/bug/openOperate.do?op=hangup&fromStatus=2&bugId=${param.bugId}" />" class="button button-rounded button-flat-primary">挂起</a>
				<a href="<c:url value="/bug/openOperate.do?op=close&fromStatus=2&bugId=${param.bugId}" />" class="button button-rounded button-flat-primary">直接关闭</a>
			</div>
		</div>
