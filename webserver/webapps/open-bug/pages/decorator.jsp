...
<head>
	...
	<script type="text/javascript" src="<c:url value="/scripts/cloud.fn.validate.js" />"></script>
	<script type="text/javascript" src="<c:url value="/scripts/cloud.ui.select.js" />"></script>
	<script type="text/javascript" src="<c:url value="/scripts/cloud.ui.tab.js" />"></script>
	<script type="text/javascript" src="<c:url value="/scripts/itemSelect.js" />"></script>
